...
export const PACKAGES: FamilyPackage[] = [
  ...
  {
    id: 'geo',
    npm: '@ph-dev-utils/geo',
    php: 'phdevutils/geo',
    version: '0.1.0',
    title: 'geo',
    tagline: 'City/municipality coordinates + distance & nearest-city.',
    highlights: [
      'A representative lat/lng for all 1,573 PSGC cities/municipalities',
      'distanceKm (haversine) — by {lat,lng} or PSGC code / name',
      'nearestCity & withinRadiusKm proximity helpers',
      'Keyed by cityMunCode — joins core / postal. Data from GeoNames (CC BY 4.0)',
    ],
    github: `${GH}/ph-geo`,
    live: true,
  },
  {
    id: 'psic',
    npm: '@ph-dev-utils/psic',
    php: 'phdevutils/psic',
    version: '0.1.0',
    title: 'psic',
    tagline: 'Philippine Standard Industrial Classification (PSIC 2009).',
    highlights: [
      '21 sections (A–U) + 88 divisions (2-digit codes)',
      'findSection / findDivision / sectionOf lookups',
      'Keyword + code search across titles',
      'Transcribed from the PSA/NSCB 2009 PSIC',
    ],
    github: `${GH}/ph-psic`,
    live: true,
  },
  {
    id: 'business',
    npm: '@ph-dev-utils/business',
    php: 'phdevutils/business',
    version: '0.1.0',
    title: 'business',
    tagline: 'Validate & parse SEC company/partnership registration numbers.',
    highlights: [
      'validateSEC / parseSEC — prefix + year + sequence',
      'CS / CN / A / FS / FN / PG prefixes with entity-type labels',
      'Canonical formatting (e.g. CS2019-12345)',
      'Pairs with psic for industry classification',
    ],
    github: `${GH}/ph-business`,
    live: true,
  },
  {
    id: 'postal',
